...
class Antiquarian(TextObjectFieldMixin, BaseModel):
    ...
    year_type = models.CharField(max_length=16, choices=YEAR_INFO_CHOICES, blank=True)
    # what the year info means
    dates_type = models.CharField(max_length=16, choices=DATES_INFO_CHOICES, blank=True)
    ...
    def display_date_range(self):
        ...
        if self.year_type == self.YEAR_RANGE:
            ...
            display_year2 = "{} {}".format(
                self.display_year2_as_range(), bcad(self.year2)
            )
