...
from rard.research.forms import (OriginalTextAuthorForm,
                                 OriginalTextDetailsForm, OriginalTextForm)
...
class OriginalTextUpdateAuthorView(CheckLockMixin, UpdateView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        context.update({
            ...
            'citing_work': self.get_citing_work_from_form() or
            self.object.citing_work,
        })
        if form_author:
    ...
    def get_form_kwargs(self):
        ...
        kwargs['citing_author'] = self.get_citing_author_from_form() or \
            self.object.citing_work.author
        kwargs['citing_work'] = self.get_citing_work_from_form() or \
            self.object.citing_work
        return kwargs
