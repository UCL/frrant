...
class TestimoniumListView(LoginRequiredMixin,
...
class TestimoniumDetailView(LoginRequiredMixin,
...
class TestimoniumDeleteView(LoginRequiredMixin,
...
class TestimoniumUpdateView(LoginRequiredMixin,
