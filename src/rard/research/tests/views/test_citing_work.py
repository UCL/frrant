...
from rard.research.views import (CitingAuthorListView, CitingAuthorDetailView,
                                 CitingWorkDeleteView, CitingWorkDetailView, 
                                 CitingWorkUpdateView, FragmentCreateView, 
                                 TestimoniumCreateView, AnonymousFragmentCreateView)
...
class TestCitingAuthorDetailView(TestCase):
    ...
    def setUp(self):
        ...
        create_views = [FragmentCreateView] * 2 + [TestimoniumCreateView] * 2 + \
    ...
    def test_order_by_work_then_reference(self):
        ...
        response_order = [item[1] for item in response.context_data['ordered_materials']]
