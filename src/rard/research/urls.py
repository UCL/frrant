...
urlpatterns = [
    ...
    path('work/', include(([
        ...
        path("<pk>/create-volume/", views.WorkVolumeCreateView.as_view(), name="create_volume"),
        path("volume/<pk>/update/", views.WorkVolumeUpdateView.as_view(), name="update_volume"),
        path("volume/<pk>/delete/", views.WorkVolumeDeleteView.as_view(), name="delete_volume"),
    ...
    path('fragment/', include(([
        ...
        path("<pk>/unlink-volume/<linked_pk>", views.FragmentRemoveVolumeLinkView.as_view(), name="remove_volume_link"),
    ...
    path('testimonium/', include(([
        ...
        path("<pk>/unlink-volume/<linked_pk>", views.TestimoniumRemoveVolumeLinkView.as_view(), name="remove_volume_link"),
